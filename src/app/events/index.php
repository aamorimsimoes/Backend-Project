      ...
      <div>
        <div class="section-title">
          ...
          <div>
            <a class="button" href="../crud/create.php?s=<?php echo $section; ?>">
              <svg viewBox="0 0 24 24" width="24" height="24"><path fill="currentColor" d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm-1-11H7v2h4v4h2v-4h4v-2h-4V7h-2v4z"/></svg>Add</a>
          </div>
        </div>
        <?php
        $sql = "SELECT * FROM events WHERE status >= ? ORDER BY date DESC";
        ...
        if ($stmt->execute([$status])) {
            ...
            if ($n > 0) {
                ...
                foreach ($data as $r) { ?>
                  <tr>
                    ...
                    <td><a href="../crud/create.php?s=events&token=<?php echo $r['token']; ?>"><?php echo $r['title']; ?></a></td>
            ...
            <?php
                ...
                echo "Não existem registos. <a href='../crud/create.php?s=events'>Inserir</a>";
            }
        } ?>
      </div>
    </div>
